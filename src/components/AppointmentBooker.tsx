          ...
          <CardContent className="flex justify-center pb-6">
            <Calendar
              ...
              classNames={{
                ...
                day_selected: "bg-dashboard-dark/90 text-dashboard-accent-teal border-2 border-dashboard-accent-teal/30 hover:bg-dashboard-dark/90 hover:text-dashboard-accent-teal font-semibold",
